...
```typescript
{
  ...
  allowedDomains: ["stackoverflow.com", "python.org", "github.com"],
...
请返回JSON:
{
  "intent": "简洁的意图描述",
  "keywords": ["关键词1", "关键词2"],
  "allowedCategories": ["允许的网站类别"],
  "blockedCategories": ["应该拦截的类别"],
  "suggestedWebsites": ["推荐网站"]
}
```
